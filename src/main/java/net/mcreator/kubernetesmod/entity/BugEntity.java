...
import net.mcreator.kubernetesmod.particle.ErrorParticleParticle;
...
import net.mcreator.kubernetesmod.entity.renderer.BugRenderer;
...
public class BugEntity extends KubernetesModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.7f)).build("bug").setRegistryName("bug");
	public BugEntity(KubernetesModModElements instance) {
		super(instance, 3);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -65536, new Item.Properties().group(KubernetesTabItemGroup.tab))
				.setRegistryName("bug_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(KubernetesIconItem.block));
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 3; ++l) {
					...
					world.addParticle(ErrorParticleParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
