...
public class DeploymentItem extends KubernetesModModElements.ModElement {
	@ObjectHolder("kubernetes_mod:deployment")
	public static final Item block = null;
	public DeploymentItem(KubernetesModModElements instance) {
		super(instance, 17);
	}
