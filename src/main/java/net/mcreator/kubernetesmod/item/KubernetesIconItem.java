...
public class KubernetesIconItem extends KubernetesModModElements.ModElement {
	@ObjectHolder("kubernetes_mod:kubernetes_icon")
	public static final Item block = null;
	public KubernetesIconItem(KubernetesModModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("kubernetes_icon");
		}
